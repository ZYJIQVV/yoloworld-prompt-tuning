...
class BaseDataset(Dataset):
    ...
    def __init__(
        ...
        # for few shot random shuffling dataset so that we can get different few shot dataset each time
    ...
    def __len__(self):
        ...
        return len(self.labels) if self.few_shot is None else self.few_shot # for few shot learning
